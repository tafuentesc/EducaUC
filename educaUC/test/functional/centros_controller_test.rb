...
class CentrosControllerTest < ActionController::TestCase
  ...
  test "should create centro" do
    assert_difference('Centro.count') do
      post :create, centro: { direccion: @centro.direccion, directora: @centro.directora, nombre: @centro.nombre, sostenedor: @centro.sostenedor, telefono: @centro.telefono }
    end
  ...
  test "should update centro" do
    put :update, id: @centro, centro: { direccion: @centro.direccion, directora: @centro.directora, nombre: @centro.nombre, sostenedor: @centro.sostenedor, telefono: @centro.telefono }
    assert_redirected_to centro_path(assigns(:centro))
  end
